                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                <?php for($i = 0; $i < count($title['headingOne']); $i++){
                                   $headingOne = $title['headingOne'][$i];
                                   $articleOne = $title[0][$i];

                                   $headingTwo = $title['headingTwo'][$i];
                                   $articleTwo = $title[0][$i];
                                   
                                };
                                    
                                
                            ?>
                            <h3><?php echo $headingOne;?></h3>
                            <p>
                                <?php echo $articleOne;?>
                            </p>
                            <h3><?php echo $headingTwo;?></h3>
                            <p>
                                <?php echo $articleTwo;?>
                            </p>
                        </div>
